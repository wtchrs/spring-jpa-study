...
public class ResponseBodyController {
    ...
    public void responseBodyStringV1(HttpServletResponse response) throws IOException {
        log.info("ResponseBodyController.responseBodyStringV1");
        response.getWriter().write("ok");
    }

    @GetMapping("/response-body-string-v2")
    public ResponseEntity<String> responseBodyStringV2() {
        log.info("ResponseBodyController.responseBodyStringV2");
    ...
    public String responseBodyStringV3() {
        log.info("ResponseBodyController.responseBodyStringV3");
        return "ok";
    }

    @GetMapping("/response-body-json-v1")
    public ResponseEntity<HelloData> responseBodyJsonV1(HttpServletResponse response) {
        log.info("ResponseBodyController.responseBodyJsonV1");
    ...
    public HelloData responseBodyJsonV2(HttpServletResponse response) {
        log.info("ResponseBodyController.responseBodyJsonV2");
        HelloData helloData = new HelloData();
        helloData.setUsername("hello");
        helloData.setAge(20);
        return helloData;
