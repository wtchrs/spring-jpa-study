...
public class LogInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        log.info("LogInterceptor.preHandle [{}][{}][{}]", logId, requestURI, handler);
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        log.info("LogInterceptor.postHandle [{}][{}]", logId, modelAndView);
    }
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
        ...
        String logId = (String) request.getAttribute(LOG_ID_ATTR_NAME);
        String requestURI = request.getRequestURI();
        log.info("LogInterceptor.afterCompletion [{}][{}]", logId, requestURI);
